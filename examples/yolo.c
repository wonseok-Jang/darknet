...
void run_yolo(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "demo")) demo(cfg, weights, thresh, cam_index, filename, voc_names, 20, frame_skip, prefix, avg, .5, 0,0,0,0, opencv_buffer_size, offset, process_num);
}
